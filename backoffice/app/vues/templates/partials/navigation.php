  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        <li><a href="<?php echo ROOTPUBLIC; ?>">Site public</a></li>
        <li class="active"><a href="<?php echo ROOT; ?>" target="_blank">Dashboard</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown-header">Catégories</li>
                <li><a href="<?php echo ROOT . 'categories' ?>">Liste des catégories</a></li>
